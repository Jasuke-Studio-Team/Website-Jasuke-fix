...
export function BlogView({ articles }: BlogViewProps) {
  return (
    <div className="max-w-5xl mx-auto px-8 py-24">
      <SEOHead 
        title="Blog"
        description="Explore articles, tutorials, and insights from Jasuke Studio — game development, 3D art, AR/VR, and creative technology."
        canonicalPath="/blog"
      />
          ...
          {articles.map((article, i) => (
            ...
            >
              <Link
                ...
                className="group block bg-[#FAFAF8] text-stone-900 rounded-sm parchment-texture shadow-xl overflow-hidden md:flex hover:shadow-amber-500/10 hover:shadow-2xl transition-all duration-500"
              >
                {/* Thumbnail */}
